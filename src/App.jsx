...
import { Menu, X, Github, Linkedin, Mail, ArrowRight, Code2, Palette, Database, Layout, Server, Smartphone, ExternalLink, Download, MapPin, Phone, GraduationCap } from 'lucide-react';
...
const Portfolio = () => {
  ...
  status: 'Completed'
},
    {
      ...
      description: 'Completed intermediate studies with computer science major, gaining fundamental knowledge in programming, mathematics, and computer systems that paved the way for higher education in software engineering.',
      status: 'Completed'
    },
    {
      year: '2017 - 2019',
...
<section id="home" className="min-h-screen flex items-center justify-center px-4 sm:px-6 relative overflow-hidden">
  ...
  <div className="max-w-4xl mx-auto text-center relative z-10">
    {/* Availability Badge (Moved Slightly More Down) */}
  ...
  <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 transition-all duration-1000 delay-1200 ${
    ...
    <div className="w-6 h-10 border-2 border-white/20 rounded-full flex justify-center p-2 animate-bounce">
      ...
      {/* Education Section - Added before Experience */}
  ...
  <div className="max-w-4xl mx-auto">
    <div className="text-center mb-16 animate-on-scroll">
      ...
      <p className="text-gray-400 max-w-2xl mx-auto mt-4">
        My educational path that built the foundation for my career in technology and design.
      </p>
    </div>
